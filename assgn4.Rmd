...
#### Lobster Size
Next, distributions of lobster sizes at each site were created in order to see how the size of lobsters present changed between 2012 and 2018, shown below in Figure XX.
...
```
In order to more formally explore the difference between MPA and non-MPA sites of changes of lobster sizes from 2012 to 2018 
```{r}
